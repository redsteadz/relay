  ...
  public: {
    Tables: {
      ...
      relay_events: {
        Row: {
          ...
          due_at: string | null;
          due_at_canonical: string | null;
          ends_at: string | null;
          ends_at_canonical: string | null;
          event_set_fingerprint: string | null;
          ...
          starts_at_canonical: string | null;
          summary: string;
    ...
    Functions: {
      ...
      persist_source_events: {
        Args: {
          p_event_set_fingerprint: string;
          p_events: Json;
