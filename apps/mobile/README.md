...
To build and open Relay on a physical Android phone without a USB cable, follow the
[wireless ADB development guide](../../docs/operations/mobile-wireless-adb.md).
